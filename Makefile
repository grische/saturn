...
$(eval $(call CURL_DOWNLOAD,freetype,2.8.1,http://download.savannah.gnu.org/releases/freetype/freetype-$$(freetype_VERSION).tar.gz))
...
$(eval $(call CURL_DOWNLOAD,hdf5,1.8.21,https://support.hdfgroup.org/ftp/HDF5/releases/hdf5-$$(word 1,$$(subst ., ,$$(hdf5_VERSION))).$$(word 2,$$(subst ., ,$$(hdf5_VERSION)))/hdf5-$$(hdf5_VERSION)/src/hdf5-$$(hdf5_VERSION).tar.gz))
$(eval $(call CURL_DOWNLOAD,ilmbase,2.2.1,http://download.savannah.nongnu.org/releases/openexr/ilmbase-$$(ilmbase_VERSION).tar.gz))
$(eval $(call CURL_DOWNLOAD,llvm,9.0.0,http://releases.llvm.org/$$(llvm_VERSION)/llvm-$$(llvm_VERSION).src.tar.xz))
$(eval $(call CURL_DOWNLOAD,openexr,2.2.1,http://download.savannah.nongnu.org/releases/openexr/openexr-$$(openexr_VERSION).tar.gz))
$(eval $(call CURL_DOWNLOAD,perl,5.26.3,http://www.cpan.org/src/5.0/perl-$$(perl_VERSION).tar.gz))
$(eval $(call CURL_DOWNLOAD,png,1.6.37,https://sourceforge.net/projects/libpng/files/libpng16/$$(png_VERSION)/libpng-$$(png_VERSION).tar.gz))
...
$(eval $(call GIT_DOWNLOAD,alembic,1.7.12,git://github.com/alembic/alembic.git))
$(eval $(call GIT_DOWNLOAD,cppzmq,v4.3.0,git://github.com/zeromq/cppzmq.git))
$(eval $(call GIT_DOWNLOAD,embree,v2.17.6,git://github.com/embree/embree.git))
$(eval $(call GIT_DOWNLOAD,ffmpeg,n4.1.5,git://github.com/FFmpeg/FFmpeg.git))
$(eval $(call GIT_DOWNLOAD,glfw,3.2.1,git://github.com/glfw/glfw.git))
$(eval $(call GIT_DOWNLOAD,jom,v1.1.3,git://github.com/qt-labs/jom.git))
$(eval $(call GIT_DOWNLOAD,jpeg,1.5.3,git://github.com/libjpeg-turbo/libjpeg-turbo.git))
$(eval $(call GIT_DOWNLOAD,jsoncpp,1.8.4,git://github.com/open-source-parsers/jsoncpp.git))
...
$(eval $(call GIT_DOWNLOAD,osl,Release-1.11.5.0-dev,git://github.com/imageworks/OpenShadingLanguage.git))
...
$(eval $(call GIT_DOWNLOAD,zlib,v1.2.11,git://github.com/madler/zlib.git))
$(eval $(call GIT_DOWNLOAD,zmq,v4.3.2,git://github.com/zeromq/libzmq.git))
$(eval $(call PYPI_INSTALL,PyOpenGL,3.1.5,https://files.pythonhosted.org/packages/b8/73/31c8177f3d236e9a5424f7267659c70ccea604dab0585bfcd55828397746/PyOpenGL-3.1.5.tar.gz))
$(eval $(call QT_DOWNLOAD,qt5creator,v4.5.2,git://github.com/qt-creator/qt-creator.git,qt5base))
